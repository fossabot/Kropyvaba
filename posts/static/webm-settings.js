...
if (window.Options) {
  ...
  prefix = '<a class="unimportant" href="javascript:void(0)">'+_('Налаштування WebM')+'</a>';
  settingsMenu.style.textAlign = "‎left";
  settingsMenu.style.background = "inherit";
  suffix = '</span>';
  style = 'display: none; text-align: left; position: absolute; left: 5em; margin-right: -999em; margin-top: -1px; padding-top: 1px; background: inherit;';
}
...
if (settingsMenu.addEventListener && !window.Options) {
    settingsMenu.addEventListener("mouseover", function(e) {
        ...
        settingsMenu.getElementsByTagName("span")[0].style.display = "block";
    }, false);
    settingsMenu.addEventListener("mouseout", function(e) {
        settingsMenu.getElementsByTagName("a")[0].style.fontWeight = "normal";
        settingsMenu.getElementsByTagName("span")[0].style.display = "none";
    }, false);
}
